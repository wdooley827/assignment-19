...
function renderContent(domEl, theRoute, theContent) {
  ...
  var profileEl = _jquery2.default.getJSON('https://api.github.com/users/' + currentUser + '?access_token=' + _secrets.githubApiKey);
  var repositoryEl = _jquery2.default.getJSON('https://api.github.com/users/' + currentUser + '/repos?access_token=' + _secrets.githubApiKey);
  ...
  _jquery2.default.when(profileEl, repositoryEl).then(function (profileData, repositoryData) {
