...
var githubApiKey = exports.githubApiKey = '70cf004c363aecad949cf44bbe62053e4ed5bd0f';
...
//${githubApiKey}
_jquery2.default.getJSON('https://api.github.com/users/wdooley827?access_token=70cf004c363aecad949cf44bbe62053e4ed5bd0f').then(function (serverRes) {
...
function renderContent(domEl, theRoute, theContent) {
  ...
  if (theRoute === 'repositories') {
    var buildProfileTemplate = function buildProfileTemplate(bioApiData, repositoriesApiData) {
